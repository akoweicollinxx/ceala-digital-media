...
const services = [
  ...
  },
  {
    ...
    description:
      "Boost your brand's online presence with our content marketing, Ad Creation, 3D Adverts, article writing, copywriting, creative content, content strategy, & content planning services",
  },
  {
    icon: "/images/s_3.png",
   ...
   bg-[size:14px_24px]"
    >
      ...
      <main className="md:pb-10">
        <div className="md:px-0 mx-6 xl:w-4/5 2xl:w-[68%] md:mx-auto pt-[130px] md:pt-[170px] mt-14">
          ...
          >
              <Link
                  href="https://docs.google.com/forms/d/e/1FAIpQLSdtCjbEaFwNB_G8DEtUkL8MU1GXHdrfabFGVcpAr6VlqNhr-g/viewform?usp=header"
                  className="py-3
            px-10
